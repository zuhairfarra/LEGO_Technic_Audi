...
async def main():
    ...
    async with BleakClient(device, handle_disconnect) as client:
        ...
        def collect_data(dataArray,dataPayload:bytearray):
            ...
            myFWspeed = float(payloadList[2])
            myRWspeed = float(payloadList[3])
            return [mytime,mycurrent,myFWspeed,myRWspeed]
        ...
        with open('loadeddrivevehicledata_540g_03.txt', 'w') as file:
